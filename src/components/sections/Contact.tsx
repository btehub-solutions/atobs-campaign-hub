                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <FormField control={form.control} name="name" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Your name" {...field} className="bg-background/50 border-border/40 rounded-xl h-11 px-4 text-sm focus:border-primary/40 transition-all duration-300" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    <FormField control={form.control} name="ward" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="e.g. Ake I" {...field} className="bg-background/50 border-border/40 rounded-xl h-11 px-4 text-sm focus:border-primary/40 transition-all duration-300" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <FormField control={form.control} name="email" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="email" placeholder="you@email.com" {...field} className="bg-background/50 border-border/40 rounded-xl h-11 px-4 text-sm focus:border-primary/40 transition-all duration-300" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    <FormField control={form.control} name="phone" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="+234..." {...field} className="bg-background/50 border-border/40 rounded-xl h-11 px-4 text-sm focus:border-primary/40 transition-all duration-300" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                  ...
                  <FormField control={form.control} name="role" render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        <FormControl>
                          <SelectTrigger className="bg-background/50 border-border/40 rounded-xl h-11 px-4 text-sm">
                  ...
                  <FormField control={form.control} name="message" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea rows={4} placeholder="Your message..." {...field} className="bg-background/50 border-border/40 rounded-xl px-4 py-3 text-sm resize-none focus:border-primary/40 transition-all duration-300" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
