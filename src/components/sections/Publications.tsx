...
const magazines = [
  ...
  {
    title: "LADEF Magazine (Part 2)",
    description: "Pages 26 to 52. Continuing the journey, featuring detailed accounts of the medical outreaches, testimonies, and the roadmap for the future.",
    href: "/PDF/MAGAZINE 3 Pg26- Pg52 B JPEG SENT TO ATOBS.pdf",
  ...
  return (
    ...
    >
      <div className="group relative w-full bg-card rounded-2xl border border-border/40 hover:border-border/80 transition-all duration-500 shadow-xl hover:shadow-2xl hover:-translate-y-1 overflow-hidden flex flex-col h-full">
        ...
        <div className="p-8 flex-1 flex flex-col bg-gradient-to-br from-background via-background to-muted/20">
          <div className="flex items-start justify-between mb-6">
            <div className="w-14 h-14 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center text-primary group-hover:scale-110 transition-transform duration-500 shadow-inner">
        ...
        {/* Action Bottom Bar */}
        <div className="p-6 border-t border-border/30 bg-background/50 backdrop-blur-md flex items-center gap-4">
           <a
             href={magazine.href}
             target="_blank"
...
const Publications = () => {
  return (
    <section id="publications" className="py-32 relative overflow-hidden bg-muted/20">
      {/* Background aesthetics */}
      <div className="section-divider absolute top-0 left-0 w-full" />
      <div className="absolute top-1/2 left-1/4 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[120px] pointer-events-none -translate-y-1/2 -translate-x-1/2" />
